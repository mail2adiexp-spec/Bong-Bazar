                  ...
                  child: _dailySales.isEmpty 
                      ...
                      : LineChart(
                          LineChartData(
                              ...
                              bottomTitles: AxisTitles(
                                sideTitles: SideTitles(
                                  ...
                                  getTitlesWidget: (value, meta) {
                                    if (value.toInt() >= 0 && value.toInt() < _dailySales.keys.length) {
                                       // Show label for every nth item to avoid clutter
                                       if (_dailySales.keys.length > 7 && value.toInt() % 3 != 0) return const SizedBox.shrink();
                                       final dateStr = _dailySales.keys.elementAt(value.toInt());
                            ...
                            lineBarsData: [
                              LineChartBarData(
                                spots: _dailySales.values.toList().asMap().entries.map((e) => FlSpot(e.key.toDouble(), e.value)).toList(),
                                isCurved: true,
                                color: Colors.blue,
                                barWidth: 3,
