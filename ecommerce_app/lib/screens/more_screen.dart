  ...
  Widget _getAboutContent() {
    return const Column(
      ...
      children: [
        ...
        SizedBox(height: 24),
        Text(
          'Demandy में आपका स्वागत है—एक नाम जिसके पीछे केवल व्यापार नहीं, बल्कि दिल का एक वादा छुपा है।',
          style: TextStyle(
            fontSize: 20,
        ...
        SizedBox(height: 8),
        Text(
          'हम सीधे किसानों से ताज़ी और शुद्ध उपज लाते हैं। आपको Demandy ऐप पर हर फल, हर सब्ज़ी में गाँव की शुद्धता मिलेगी। और हाँ, हम यह सब आपके अपनों तक पहुँचाने के लिए कोई डिलीवरी शुल्क नहीं लेते हैं।',
          style: TextStyle(fontSize: 15, height: 1.6, color: Colors.black87),
        ),
        SizedBox(height: 20),
        Text(
        ...
        Divider(height: 32, thickness: 1),
        Text(
          'Demandy में हम व्यक्तिगत रूप से इस बात की गारंटी देते हैं कि आपको हमेशा सर्वोत्तम ही मिले। आपका विश्वास ही हमारी सबसे बड़ी कमाई है।',
          style: TextStyle(
            fontSize: 16,
            fontWeight: FontWeight.w600,
            color: Colors.black87,
        ...
        SizedBox(height: 16),
        Text(
          'आप हमारे Demandy ऐप के माध्यम से आसानी से ऑर्डर या बुकिंग कर सकते हैं, या किसी भी ज़रूरत के लिए हमें सीधे 7479223366 पर कॉल कर सकते हैं।',
