...
class InvoiceService {
      ...
      pw.MultiPage(
        ...
        build: (pw.Context context) {
          return [
            ...
            _buildCustomerAndOrderInfo(order),
  ...
  static Future<void> generateShippingLabel(OrderModel order) async {
    final font = await PdfGoogleFonts.robotoRegular();
    final boldFont = await PdfGoogleFonts.robotoBold();
        ...
        build: (pw.Context context) {
          return pw.Column(
            ...
            children: [
              ...
              pw.Text(order.userId, style: pw.TextStyle(fontWeight: pw.FontWeight.bold, fontSize: 14)), // Ideally Customer Name
  ...
  static pw.Widget _buildCustomerAndOrderInfo(OrderModel order) {
    return pw.Row(
      crossAxisAlignment: pw.CrossAxisAlignment.start,
      mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
      children: [
        pw.Expanded(
          child: pw.Column(
            ...
            children: [
              ...
              pw.Text(order.userId, style: pw.TextStyle(fontWeight: pw.FontWeight.bold)), 
